      ...
      <div className="pt-40 pb-32 px-6 md:px-12 bg-[#0f0e0c] min-h-screen">
        <div className="container mx-auto max-w-3xl text-center">
          <FadeIn>
            ...
            <p className="mt-6 text-white/75 font-light leading-relaxed max-w-lg mx-auto">
          ...
          <FadeIn delay={0.2}>
            <div className="flex flex-wrap justify-center gap-3 mt-10">
              {[
                ...
                <span key={tag} className="border border-white/25 text-white/70 text-xs tracking-[0.15em] uppercase px-4 py-2">
                  {tag}
                </span>
              ))}
            </div>
