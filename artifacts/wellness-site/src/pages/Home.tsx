...
const projetos = [
  ...
  { img: "/six-cover.png", name: "Six Wowness Club — Itaim", desc: "Experiência do usuário e jornada do cliente em um clube wellness premium no coração do Itaim." },
];

const partners = [
  { name: "Technogym", src: "/partner-technogym.png" },
  { name: "Tryex", src: "/partner-tryex.png" },
  { name: "Six Wowness Club", src: "/partner-six.png" },
  ...
  { name: "Latam Wellness", src: "/partner-latam.png" },
  { name: "Starpool", src: "/partner-starpool.png" },
];
...
export default function Home() {
  ...
  return (
    <PageWrapper>
              ...
              {partners.map((p) => (
                ...
                >
                  <img
                    ...
                    alt={p.name}
                    loading="lazy"
                    className={`${p.src.includes("partner-six") || p.src.includes("partner-aguilera") || p.src.includes("partner-latam") ? "max-h-20 md:max-h-24" : "max-h-12 md:max-h-14"} max-w-[78%] w-auto object-contain opacity-80 hover:opacity-100 transition-opacity duration-500`}
                  />
                </div>
              ))}
            </div>
      ...
      {/* Contato CTA */}
      <section className="py-16 md:py-32 px-6 md:px-12 border-t border-white/10 bg-[#0f0e0c]">
